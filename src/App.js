  ...
  return (
    <div className="App">
      ...
      <div className='Intro'>
        ...
        <h2 id='miniDescription'>Designing mobile-first solutions for business analytics and operations @ Toast. I believe great design has the power to make the digital world inclusive for everyone.</h2>
