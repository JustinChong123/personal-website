...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div className='Intro'>
        <Typewriter />
        <h2><span class="blueText">Product designer</span> leveraging metrics-driven experimentation to lift user and business outcomes across B2B and B2C</h2>
        <h2 id='miniDescription'>Designing mobile-first solutions for business analytics and operations @ Toast (ex-MongoDB). I believe great design has the power to make the digital world inclusive for everyone.</h2>
